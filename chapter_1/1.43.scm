...
; be the function whose value at x is f(f(…(f(x))…)). For example, if f is
; the function x ↦ x+1, then the nth repeated application of f is the function
...
; and a positive integer n and returns the procedure that computes the nth
